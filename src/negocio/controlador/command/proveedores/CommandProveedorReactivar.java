...
public class CommandProveedorReactivar implements Command {

	private Retorno retorno;
	private TransferProveedor datos;

	public CommandProveedorReactivar() {
		retorno = null;
		datos = null;
	}

	public CommandProveedorReactivar(TransferProveedor datos) {
		retorno = null;
		this.datos = datos;
	}
	...
	public Retorno execute() {
		...
		retorno = SA.reactivarProveedor(datos);
		return retorno;
	}
